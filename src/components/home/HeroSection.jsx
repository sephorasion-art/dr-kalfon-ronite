        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-col items-start gap-1 mt-10">
              <span className="text-xs text-muted-foreground uppercase tracking-widest">{t.hero.certified}</span>
              <img
              ...
              />
              <span className="text-xs font-semibold text-primary uppercase tracking-widest">{t.hero.centre}</span>
            </div>
            ...
            <div className="flex items-center gap-8 mt-8 pt-8 border-t border-border/50">
              ...
              <div className="w-px h-10 bg-border" />
              <div>
                <div className="text-2xl font-bold text-foreground">{t.hero.stat3label}</div>
                <div className="text-xs text-muted-foreground uppercase tracking-wider">{t.hero.stat3}</div>
              </div>
            </div>
          </motion.div>
